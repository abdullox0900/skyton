  ...
  return (
    <div className="space-y-[5px]">
      {starData.map((item, index) => {
        ...
        const isLast = index === starData.length - 1;
        ...
        return (
          <div
            key={index}
            className={`flex flex-col sm:flex-row items-stretch sm:items-center justify-between bg-[#0E1423] ${roundedClass} py-[12px] sm:py-[14px] md:py-[16px] px-[12px] sm:px-[16px] md:px-[20px] lg:px-[24px] gap-[12px] sm:gap-0`}
          >
